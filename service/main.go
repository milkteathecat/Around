...
const (
	...
	DISTANCE = "200km"
	// Needs to update
	PROJECT_ID = "around-185919"
	BT_INSTANCE = "around-post"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://104.196.191.45:9200"
	ENABLE_MEMCACHE = true
	BUCKET_NAME = "post-images-185919"
	REDIS_URL       = "redis-17772.c1.us-central1-2.gce.cloud.redislabs.com:17772"
)
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	lat, _ := strconv.ParseFloat(r.URL.Query().Get("lat"), 64) // the _ is the potential err
